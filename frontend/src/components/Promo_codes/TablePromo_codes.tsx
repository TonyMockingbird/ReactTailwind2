...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/promo_codes/promo_codesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configurePromo_codesCols';
...
const TableSamplePromo_codes = ({ filterItems, setFilterItems, filters }) => {
  ...
  const {
    ...
    loading,
    count,
    notify: promo_codesNotify,
    refetch,
  } = useAppSelector((state) => state.promo_codes);
  ...
  useEffect(() => {
    if (promo_codesNotify.showNotification) {
      notify(
        promo_codesNotify.typeNotification,
        promo_codesNotify.textNotification,
      );
    }
  }, [promo_codesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/promo_codes/promo_codes-view/?id=${id}`);
  };
...
export default TableSamplePromo_codes;

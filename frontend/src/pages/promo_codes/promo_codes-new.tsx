...
import { create } from '../../stores/promo_codes/promo_codesSlice';
...
Promo_codesNew.getLayout = function getLayout(page: ReactElement) {
  return <LayoutAuthenticated>{page}</LayoutAuthenticated>;
};

export default Promo_codesNew;
